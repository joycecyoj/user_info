...
class Visuals extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .post('http://localhost:5000/api/info', this.props.data)
      .then(response => {
    ...
    return (
      ...
      <h2>The following charts display your data in 7 ways:</h2>
        ...
        <ul>
          ...
          <p>4. Percentage of people in each state, up to the top 10 most populous states</p>
          <p>5. Percentage of females in each state, up to the top 10 most populous states</p>
          <p>6. Percentage of males in each state, up to the top 10 most populous states</p>
          <p>7. Percentage of people in the following age ranges: 0‐20, 21‐40, 41‐60, 61‐80, 81‐100,100+</p>
        </ul>
        </div>
      </div>
